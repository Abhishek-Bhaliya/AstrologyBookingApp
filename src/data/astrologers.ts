...
const astrologers: Astrologer[] = [
  ...
  { id: '4', name: 'Guru Anil Verma', expertise: 'Tarot Reading', experience: 10, rate: 80 },
  { id: '5', name: 'Sage Meera Devi', expertise: 'Face Reading', experience: 9, rate: 65 },
  { id: '6', name: 'Acharya Mohan Lal', expertise: 'Horoscope Matching', experience: 14, rate: 75 },
  { id: '7', name: 'Swami Rajeshwar', expertise: 'Kundli Analysis', experience: 18, rate: 90 },
  { id: '8', name: 'Jyotika Sharma', expertise: 'Gemstone Consultation', experience: 11, rate: 85 },
